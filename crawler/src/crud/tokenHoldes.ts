...
import { insert, dropDuplicatesMultiKey, logger } from '../utils';
...
export const insertAccountTokenHolders = async (tokenHolders: TokenHolder[]): Promise<void> => insert(
...
export const insertContractTokenHolders = async (tokenHolders: TokenHolder[]): Promise<void> => insert(
  `${TOKEN_HOLDER_INSERT_STATEMENT}
...
export const insertAccountNftHolders = async (tokenHolders: TokenHolder[]): Promise<void> => insert(
  `${TOKEN_HOLDER_INSERT_STATEMENT}
...
export const insertContractNftHolders = async (tokenHolders: TokenHolder[]): Promise<void> => insert(
  `${TOKEN_HOLDER_INSERT_STATEMENT}

...
import { insertEvmEventFailure } from '../../../../crud';
import { logger, toChecksumAddress } from '../../../../utils';
import AccountManager from '../../../managers/AccountManager';
import { CompleteEvmDataV2, ExtrinsicData } from '../../../../types';
import DefaultEvent from './DefaultEvent';

class ExecutedFailedEvent extends DefaultEvent {
  data: CompleteEvmDataV2 | undefined;
